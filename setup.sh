...
sudo apt-get install -y busybox-static fakeroot git dmsetup kpartx netcat-openbsd nmap python3-psycopg2 python3-pip snmp 
...
# Clone repos
sudo apt-get install -y binwalk nano john
